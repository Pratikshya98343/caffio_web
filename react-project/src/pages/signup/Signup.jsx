...
const SignUp = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      console.log(`Failed to create account: ${error.message || "Please try again."}`);
    }
  };
  ...
  return (
    <div className="fixed inset-0 flex-col flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-cyan-50 p-4">
      <div className="h-18 w-full"></div>
      <div className="max-w-md w-full bg-white rounded-xl shadow-2xl overflow-hidden transform transition-all duration-300 hover:scale-[1.01] my-15"> 
        <div className="bg-caffio-brown px-8 py-6 text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Create Account</h1>
          <p className="text-caffio-cream text-lg">
            Join us today and enjoy your coffee!
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-caffio-light-brown focus:border-caffio-light-brown transition duration-200 ${
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-2 pr-10 border rounded-lg focus:ring-2 focus:ring-caffio-light-brown focus:border-caffio-light-brown transition duration-200 ${
